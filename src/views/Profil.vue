        ...
        <div class="md:flex no-wrap md:-mx-2 ">
            ...
            <div class="w-full md:w-3/12 md:mx-2">
                ...
                <div class="bg-white p-3 border-t-4 border-purple-400">
                    ...
                    <p class="text-sm text-gray-500 hover:text-gray-600 leading-6">semoga para pembeli 
                        Bisa menikmati perbelanjaanya dari website kami.
                    ...
                    <ul
                        ...
                        <li class="flex items-center py-3">
                            ...
                            <span class="ml-auto"><span
                                    class="bg-purple-500 py-1 px-2 rounded text-white text-sm">Active</span></span>
                        </li>
                        <li class="flex items-center py-3">
                    ...
                    <div class="text-gray-700" >
                        <div class="grid md:grid-cols-2 text-sm" >
                            ...
                            <div class="grid grid-cols-2">
                                ...
                                <div class="px-4 py-2">{{ address.phone }}</div>
                            </div>
                             <div class="grid grid-cols-2 py-1">
                                <div class="px-4 py-2 font-semibold">Birthday</div>
                                <div class="px-4 py-2">Nov 05, 2005</div>
                            </div>
                            <div class="grid grid-cols-2">
                                <div class="px-4 py-2 font-semibold">Shipping Address</div>
                                <div class="px-4 py-2">{{ address.address }}, {{  address.city }}, {{  address.state }}, {{  address.country }}, {{  address.postal_code }}</div>
                            </div>
                            <div class="grid grid-cols-2">
                                <div class="px-4 py-2 font-semibold">Billing Address</div>
                                <div class="px-4 py-2">{{ address.address }}, {{  address.city }}, {{  address.state }}, {{  address.country }}, {{  address.postal_code }}</div>
                            </div>
...
export default {
  computed: {
      ...
      address() {
          return this.getterUserAddress.data[0]
        }
  },
  methods: {
