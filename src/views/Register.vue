            ...
            <div class="lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0"
                ...
                <div class="w-full py-6 z-20">
                    ...
                    <form @submit.prevent="performRegister" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                        ...
                        <div class="pb-2 pt-4">
                            <input class="block w-full p-4 tex  t-lg rounded-sm bg-black" v-model="password" type="password"
                        ...
                        <div class="text-sm flex justify-between items-center mt-3">
                            ...
                            <a href="/login"
                                class="py-2 px-5 ml-3  border rounded-xl hover:scale-110 duration-300 border-purple-400  ">Login</a>
                        </div>
                    </form>
                </div>
            </div>
